...
import {
  furnitureCasters,
  furnitureCastersContent,
} from "../../data/Products/Furniture_castor";

const ITEMS_PER_PAGE = 9;

export default function FurnitureCasters() {
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:flex lg:gap-8 lg:px-8">
        ...
        >
          ...
          <div className="p-5 lg:p-0">
            ...
            <section className="mt-6">
              ...
              {[
                "TPR / Soft Polyurethane (PU)",
                "Soft Rubber",
                "Polyurethane (PU) / Nylon",
                "Polyurethane (PU) / Rubber",
                "Polyurethane (PU) with designer housing",
                "Nylon / Polyurethane (PU)",
                "Noise-Dampening Polyurethane (PU)",
              ].map((mat) => (
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-sm text-gray-600">
            ...
            <strong className="text-gray-900">{totalItems}</strong> furniture castors
          </p>

          {totalItems === 0 ? (
            <div className="py-20 text-center text-gray-500">
              No furniture castors match your filters.
              <button
                onClick={resetFilters}
              ...
              <div className="mt-8 grid gap-10 md:grid-cols-2">
                ...
                <div className="space-y-6">
                  <dl className="grid grid-cols-2 gap-6">
                    ...
                    {selectedProduct.mount_type && (
                      <div>
                        <dt className="text-sm text-gray-500">Mount Type</dt>
                        <dd className="mt-1 text-xl font-semibold">
                          {selectedProduct.mount_type}
                        </dd>
                      </div>

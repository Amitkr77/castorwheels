  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    if (search.trim()) {
      ...
      result = result.filter((p) =>
        ...
        (p.wheel_material?.toLowerCase().includes(term))
      );
    }
  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <MdOutlineChevronRight className="text-lg" aria-hidden="true" />
            <span className="font-medium text-gray-900">Automotive Assembly</span>
          </nav>
          ...
          <p className="mt-3 text-base text-gray-600 max-w-3xl">
            Precision-engineered caster wheels built for heavy loads, smooth movement, and long service life in automotive assembly lines, jigs, fixtures, and automation systems.
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:flex lg:gap-8 lg:px-8">
        ...
        <aside
          className={`fixed inset-y-0 left-0 z-40 w-80 transform bg-white shadow-xl transition-transform lg:relative lg:translate-x-0 lg:shadow-none h-fit lg:border lg:rounded-xl lg:p-6 lg:top-24 ${
        ...
        >
          ...
          <div className="p-5 lg:p-0">
            <div className="flex items-center justify-between pb-5 border-b lg:hidden">
              <button
            ...
            <section className="mt-6">
              ...
              {["Polyamide (PA)", "Cast Iron + Polyurethane (PU)"].map((mat) => (
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-sm text-gray-600">
            ...
            <strong className="text-gray-900">{totalItems}</strong> castors
          </p>

          {/* Products */}
          {totalItems === 0 ? (
            <div className="py-20 text-center text-gray-500">
              No castors match your filters.
              <button
                onClick={resetFilters}

  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <MdOutlineChevronRight className="text-lg" aria-hidden="true" />
            <span className="font-medium text-gray-900">Custom Mobility Solutions</span>
          </nav>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:flex lg:gap-8 lg:px-8">
        ...
        <aside
          className={`fixed inset-y-0 h-fit left-0 z-40 w-80 transform bg-white shadow-xl transition-transform lg:relative lg:translate-x-0 lg:shadow-none lg:border lg:rounded-xl lg:p-6 lg:top-24 ${
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-sm text-gray-600">
            ...
            <strong className="text-gray-900">{totalItems}</strong> custom solutions
          </p>

          {totalItems === 0 ? (
            <div className="py-20 text-center text-gray-500">
              No custom mobility solutions match your filters.
              <button
                onClick={resetFilters}
                ...
                {selectedProduct.badge && (
                  <span
                    className={`inline-block px-3 py-1 text-xs font-bold uppercase rounded-full text-white ${
                      ...
                      selectedProduct.badge.toLowerCase().includes("premium")
                        ? "bg-blue-600"
                        : "bg-green-600"
                    }`}
                  >
              ...
              <div className="mt-8 grid gap-10 md:grid-cols-2">
                ...
                <div className="space-y-6">
                  <dl className="grid grid-cols-2 gap-6">
                    <div>
                      <dt className="text-sm text-gray-500">Max Load Capacity</dt>
                      <dd className="mt-1 text-xl font-semibold">
                        {selectedProduct.max_load_capacity_kg} kg
                      </dd>
                    </div>
                    <div>
                      <dt className="text-sm text-gray-500">Wheel Material</dt>
                      <dd className="mt-1 text-xl font-semibold">
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-xl font-semibold">
                        {selectedProduct.available_sizes_mm?.join(" / ") || "—"}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-sm text-gray-500">Customization</dt>
                      <dd className="mt-1 text-xl font-semibold">
        ...
        <div className="absolute top-3 left-3 z-10">
          <span
            className={`inline-block px-2.5 py-1 text-xs font-bold uppercase rounded-md text-white ${
              ...
              product.badge.toLowerCase().includes("premium")
                ? "bg-blue-600"
                : "bg-green-600"
            }`}
          >
      ...
      <div className={`flex flex-1 flex-col p-5 ${isList ? "p-0 pr-5" : ""}`}>
        ...
        <div className={`flex flex-wrap gap-2.5 text-sm ${isList ? "mt-2" : "mt-1"}`}>
          <div className="flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1">
            ...
            <span className="font-medium">{product.max_load_capacity_kg} kg</span>
          </div>
          <div className="flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1">
          ...
          <div className="flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1 max-w-full">

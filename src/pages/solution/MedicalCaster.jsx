      ...
      <div className="mx-auto w-full max-w-7xl grow px-4 py-8 sm:px-6 lg:flex lg:gap-8 lg:px-8">
        ...
        <aside className="hidden lg:block lg:w-72 lg:shrink-0">
          <div className="sticky top-24 rounded-xl bg-white dark:bg-slate-900 p-6 shadow-sm border border-gray-200 dark:border-slate-800">
            ...
            {/* Wheel Material – updated to match real values */}
            <section className="mt-6">
              ...
              {[
                ...
                "Twin PU / TPR",
                "PU + Stainless Steel",
                "Conductive Polyurethane (ESD-safe)",
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedProduct(null)}
              aria-label="Close"
              className="absolute top-5 right-5 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-800 hover:bg-gray-200 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
            >
              ✕
            </button>
            ...
            <div className="p-6 md:p-10">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-end">
                <button
                  onClick={() => setSelectedProduct(null)}
                  className="px-8 py-3 rounded-xl border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800"
                >
                  Close
                </button>
                <button className="px-8 py-3 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700">
                  Inquire Now
                </button>
              </div>
            </div>

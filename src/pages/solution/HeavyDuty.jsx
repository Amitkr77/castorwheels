      ...
      <header className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <MdOutlineChevronRight className="text-lg" aria-hidden="true" />
            <span className="font-medium text-gray-900">Heavy Duty / Ultra Heavy</span>
          </nav>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:flex lg:gap-8 lg:px-8">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-sm text-gray-600">
            ...
            <strong className="text-gray-900">{totalItems}</strong> heavy-duty castors
          </p>

          {totalItems === 0 ? (
            <div className="py-20 text-center text-gray-500">
              No heavy-duty castors match your filters.
              <button
                onClick={resetFilters}
                ...
                {selectedProduct.badge && (
                  <span
                    className={`inline-block px-3 py-1 text-xs font-bold uppercase rounded-full text-white ${
                      ...
                      selectedProduct.badge?.toLowerCase().includes("ultra")
                        ? "bg-blue-600"
                        : "bg-green-600"
                    }`}
                  >
        ...
        <div className="absolute top-3 left-3 z-10">
          <span
            className={`inline-block px-2.5 py-1 text-xs font-bold uppercase rounded-md text-white ${
              ...
              product.badge?.toLowerCase().includes("ultra")
                ? "bg-blue-600"
                : "bg-green-600"
            }`}
          >
